...
#' unique		Variable is coerced into a factor with no "binning" at all
#' explicitcuts The user supplies “cut points” for partitioning the data
#' range		The user specifies a number of cut points, and they are the generated by cutting the range of the values of the variable into the given number
#' logrange		As above, but done by range of the log of the variable
#' counts		User specifies number of cut points, and the bins are then generated so that the bins have equal amounts of data
