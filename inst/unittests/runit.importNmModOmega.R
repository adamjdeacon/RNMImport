...
test.importNmModOmega <- function(){
	...
	checkEquals( rownames(out5), c("OMEGA11 | FALSE", "OMEGA22 | FALSE", "OMEGA33 | TRUE",  
					"OMEGA44 | FALSE",	"OMEGA55 | FALSE",  "OMEGA66 | FALSE",  
					"OMEGA77 | FALSE", "OMEGA88 | FALSE", "OMEGA99 | FALSE", 
					"OMEGA1010 | FALSE"), msg = "dimnames" )
	dimnames(out5) <- NULL
