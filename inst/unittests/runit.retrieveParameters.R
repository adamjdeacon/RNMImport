...
test.getThetas <- function()
{
	...
	checkEquals(attr(getThetas(prob1, initial = TRUE), "Initial"),  expAttributes)
	...
	attrSim <- c(19.6, 84.6, 1.66)
	names(attrSim) <- c("THETA1", "THETA2", "THETA3")
