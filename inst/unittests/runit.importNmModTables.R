...
test.importNmModTables <- function() {
  ...
  checkEquals(vec1[["Columns"]] , "ID, TIME, DV, CMT, EVID, AMT, RATE, CL, V1, K, K12, K21, SCRT, AGE, SEX, BW, CLCR, IPRED, PRED, WRES, IRES, IWRES, RES", msg = "check 1 (columns)")
  ...
  df2 <- data.frame(
    File="TES8BA03.fit",
    Columns="ID, TIME, CL, Q, V1, V2, VSS, MDV, CYCL, WT, CMT, IPRE, IRES, IWRS, DV, PRED, RES, WRES",
  ...
  checkEquals( vec3$Columns , c("ID, TIME, AMT, IPRE, DOSE, FAST, VMAX, DV, PRED, RES, WRES",
  ...
  checkEquals( vec4$Columns , c("ID, TIME, DV, IPRED, PRED, WRES, IWRES, IRES, MDV, ATIM, OCC, GRP, RES",
                                "ID, CL, K30, V3, K34, K43, K12, K23, OCC, GRP, F1, ALAG1, DV, PRED, RES, WRES",
                                "ID, ETA1, ETA2, ETA3, ETA4, ETA5, ETA6, ETA7, ETA8, DV, PRED, RES, WRES"), msg = "check 4 (columns)")
