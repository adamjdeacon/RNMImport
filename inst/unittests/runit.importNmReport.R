...
test.importNmReport.Basic <- function()
{
	...
	checkEquals(names(probRes[[1]]), c("VersionInfo", "nRecords", "nIndividuals", "Objective.Minimum", "FinalEstimates","Iter" ), 
...
test.importNmReport.SimModel <- function()
{
	...
	checkEquals(names(probRes[[1]]), c("VersionInfo", "nRecords", "nIndividuals", "FinalEstimates"), "checking presence of correct elements in report" )
