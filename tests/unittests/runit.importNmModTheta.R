...
test.importNmModTheta <- function(){
	...
	input1 <- c(
			...
			"(500,3000,6000)  ",
			"(0.1)            ")
	output1 <- .importNmModTheta(input1)
	...
	input2 <- c(
			...
			" (0,0.02)      ",
			" (0,2.5)       ")
	output2 <- .importNmModTheta(input2)
	...
	output3 <- .importNmModTheta(input3)
	...
	input4 <- c(
			...
			"$THETA  (0,2.7,22)           ",
			"$THETA  (0,0.19,1.6)         ")
	output4 <- .importNmModTheta(input4)
	...
	input5 <- c("$THETA", " (0,50,100)      ", " (0,250,500)     ", " (0,50,100)      ",
			...
			" (-1,-0.29)    ", " (-1,0.30)    ")
	output5 <- .importNmModTheta(input5)
	...
	input6 <- c(
			...
			"0 FIXED                   ",
			"0.1                  ")
	output6 <- .importNmModTheta(input6)
	...
	input7 <- c(
			...
			"$THETA  (0,2.7,22)           ",
			"$THETA  (0,0.19,1.6)       ;  ~X9")
	output7 <- .importNmModTheta( input7 )
	n7 <- rownames(output7)
	checkEquals( n7[1], "X1")
	checkEquals( n7[2], "X2")
	checkEquals( n7[3], "X3")
	...
	input8 <- c(
			...
			"$THETA  (0,2.7,22)           ",
			"$THETA  (0,0.19,1.6)         ;~ X9")
	output8 <- .importNmModTheta( input8, rx = "#[[:space:]]*([[:alnum:]]*)" )
	n8 <- rownames(output8)
	checkEquals( n8[1], "X1")
	checkEquals( n8[2], "X2")
	checkEquals( n8[3], "X3")
	...
	input9 <- c("$THETA (9,11,13) (0,0.01,0.1)            ",
			...
			"     (9,11,13) (9,12,13)                 ")
	output9 <- .importNmModTheta( input9 )
